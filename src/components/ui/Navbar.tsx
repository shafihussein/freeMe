...
const NavMegaMenu01 = () => {
 ...
 {menuItem.badge && (
 <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400 text-[10px] font-black uppercase tracking-widest">{menuItem.badge}</span>
 )}
 </div>
 ...
 {/* Right CTA */}
 <div className="flex items-center gap-3">
 <Button variant="ghost" className="font-bold text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hidden sm:flex">
 Sign In
 </Button>
 ...
 Hover over <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-600">solutions</span><br/> to see the magic.
 </h1>
 </div>
